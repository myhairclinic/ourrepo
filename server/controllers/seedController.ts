  ...
  try {
    const packages = [
      ...
      },
      {
        ...
        contentRU: "Специально подготовленный для наших пациентов из Азербайджана, этот пакет предлагает комфортное пребывание в Тбилиси с удобным транспортом из Баку. Проживание в 5-звездочном отеле, VIP-трансфер и экскурсия с гидом включены.",
      ...
      {
        slug: "premium-hair-transplant-kz",
      ...
      },
      {
        ...
        contentTR: "Azerbaycanlı hastalarımız için özel olarak hazırlanmış bu lüks paket, saç ekimi ve Azerbaycan kültürünü bir araya getiriyor. 5 yıldızlı otelde süit konaklama, VIP transferler ve kişisel rehber hizmetimiz bulunmaktadır.",
        contentEN: "This luxury package, specially prepared for our Azerbaijani patients, combines hair transplantation with Azerbaijani culture. Suite accommodation in a 5-star hotel, VIP transfers, and personal guide services are available.",
        contentRU: "Этот роскошный пакет, специально подготовленный для наших азербайджанских пациентов, сочетает в себе трансплантацию волос с азербайджанской культурой. Доступны проживание в люксе в 5-звездочном отеле, VIP-трансферы и услуги персонального гида.",
        contentKA: "ეს ლუქსი პაკეტი, სპეციალურად მომზადებული ჩვენი აზერბაიჯანელი პაციენტებისთვის, აერთიანებს თმის გადანერგვას აზერბაიჯანულ კულტურასთან. ხელმისაწვდომია სუიტის საცხოვრებელი 5-ვარსკვლავიან სასტუმროში, VIP ტრანსფერები და პირადი გიდის მომსახურება.",
        imageUrl: "/images/packages/premium-package-az.jpg",
        countryOrigin: "AZ",
        durationDays: 5,
      ...
      },
      {
        ...
        contentTR: "Ukraynalı hastalarımız için özel olarak hazırlanmış lüks paket. 5 yıldızlı otelde süit konaklama, VIP transfer, Ukrayna mutfağı sunan restoranda akşam yemeği ve kişisel rehberli şehir turu içerir.",
        contentEN: "Luxury package specially prepared for our Ukrainian patients. Includes suite accommodation in a 5-star hotel, VIP transfers, dinner at a restaurant offering Ukrainian cuisine, and a city tour with a personal guide.",
        contentRU: "Роскошный пакет, специально подготовленный для наших украинских пациентов. Включает проживание в люксе в 5-звездочном отеле, VIP-трансферы, ужин в ресторане, предлагающем украинскую кухню, и экскурсию по городу с персональным гидом.",
        contentKA: "ლუქსი პაკეტი, სპეციალურად მომზადებული ჩვენი უკრაინელი პაციენტებისთვის. მოიცავს სუიტის საცხოვრებელს 5-ვარსკვლავიან სასტუმროში, VIP ტრანსფერებს, ვახშამს რესტორანში, რომელიც გთავაზობთ უკრაინულ სამზარეულოს და ქალაქის ტურს პირადი გიდით.",
      ...
      },
      {
        ...
        contentTR: "İranlı hastalarımız için özel olarak hazırlanmış lüks paket. 5 yıldızlı otelde süit konaklama, VIP transferler, İran mutfağı sunan restoranda akşam yemeği ve Farsça konuşan rehber eşliğinde kapsamlı şehir turu içerir.",
