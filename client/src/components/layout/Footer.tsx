        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 py-5">
            ...
            <div className="lg:col-span-2">
              <div className="mb-6">
                <h3 className="text-lg font-bold text-white !important" style={{color: 'white !important'}}>{t("footer.quickLinks")}</h3>
            ...
            <div className="lg:col-span-3">
              <div className="mb-6">
                <h3 className="text-lg font-bold text-white !important" style={{color: 'white !important'}}>{t("footer.ourServices")}</h3>
                <div className="h-0.5 w-12 bg-blue-500 mt-2 rounded-full"></div>
              </div>
            ...
            <div className="lg:col-span-3">
              <div className="mb-6">
                <h3 className="text-lg font-bold text-white !important" style={{color: 'white !important'}}>{t("footer.workingHours")}</h3>
                <div className="h-0.5 w-12 bg-blue-500 mt-2 rounded-full"></div>
              </div>
