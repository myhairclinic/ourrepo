              ...
              <div className="bg-background rounded-2xl overflow-hidden shadow-xl border border-gray-100 dark:border-gray-800">
                ...
                <div className="p-6 bg-gray-50 dark:bg-gray-900">
                  ...
                  <div className="flex gap-3">
                    ...
                    <a 
                      href={SOCIAL.TWITTER}
                      className="h-10 w-10 flex items-center justify-center rounded-full bg-[#1DA1F2] text-white hover:opacity-90 transition-opacity"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="Twitter"
                    >
                    ...
                    <a 
                      href={SOCIAL.YOUTUBE}
                      className="h-10 w-10 flex items-center justify-center rounded-full bg-[#FF0000] text-white hover:opacity-90 transition-opacity"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="YouTube"
                    >
