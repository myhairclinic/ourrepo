...
(
  ...
  'DHI ve FUE teknikleri ile doğal sonuçlar veren saç ekimi uygulamaları.', 
  ...
  'Saç ekimi, saç dökülmesi sorunu yaşayan kişilere kalıcı bir çözüm sunan cerrahi bir işlemdir. Kliniğimizde DHI ve FUE gibi modern teknikleri kullanarak, doğal görünümlü ve kalıcı sonuçlar elde edilmesini sağlıyoruz. İşlem, kendi saç köklerinizin alındığı donör bölgeden, saçların döküldüğü alıcı bölgeye nakledilmesini içerir.', 
  ...
  '1. Konsültasyon: Saç dökülme tipiniz ve beklentileriniz değerlendirilir.
2. Planlama: Donör ve alıcı bölge için detaylı bir plan hazırlanır.
3. Anestezi: Lokal anestezi uygulanır.
4. Greft Toplama: Donör bölgeden saç kökleri alınır.
5. Kanal Açma: Alıcı bölgede mikro kanallar açılır.
6. Yerleştirme: Greftler bu kanallara yerleştirilir.
7. Tamamlama: İşlem sonrası bakım talimatları verilir.',
...
- Kalıcı saç dökülmesi yaşayanlar
...
- İlk 3 gün boyunca nakil bölgesine dokunmayın
- 2 hafta boyunca ağır sporlardan kaçının
- Doktorunuzun önerdiği şampuan ve ilaçları kullanın
- Direkt güneş ışığına maruz kalmaktan kaçının
...
(
  ...
  'Seyrek sakal sorunu için kalıcı çözüm sunan sakal ekimi uygulamaları.', 
  ...
  'Sakal ekimi, sakal bölgesinde seyreklik, boşluk veya asimetri sorunları yaşayan erkekler için kalıcı bir çözüm sunan işlemdir. Saç ekimine benzer teknikler kullanılarak, kişinin kendi saç köklerinin sakal bölgesine nakledilmesiyle gerçekleştirilir. Bu sayede doğal görünümlü, kalıcı ve sık bir sakal elde edilir.', 
  ...
  '1. Konsültasyon: Sakal yapınız ve beklentileriniz değerlendirilir.
2. Planlama: Donör ve alıcı bölge için plan yapılır.
3. Anestezi: Lokal anestezi uygulanır.
4. Greft Toplama: Başın arka kısmından saç kökleri alınır.
5. Kanal Açma: Sakal bölgesinde mikro kanallar açılır.
6. Yerleştirme: Greftler bu kanallara yerleştirilir.
7. Tamamlama: İşlem sonrası bakım talimatları verilir.',
...
- Sakal bölgesinde seyreklik veya boşluk olanlar
- Sakal çıkmayan alanlarda sakal isteyen erkekler
- Genel sağlık durumu iyi olanlar
- Gerçekçi beklentileri olanlar
- 25 yaş üstü olanlar',
...
- ისინი, ვინც 25 წელზე მეტისაა',
  ...
  'Sakal ekimi sonrası bakım:
- İlk 3 gün boyunca nakil bölgesine dokunmayın
- 2 hafta boyunca tıraş olmayın
- Doktorunuzun önerdiği şampuan ve ürünleri kullanın
- Direkt güneş ışığına maruz kalmaktan kaçının
- Düzenli kontrollere gelin',
...
(
  ...
  'Seyrek ve şekilsiz kaşlar için kalıcı çözüm sunan kaş ekimi uygulamaları.', 
  ...
  'Kaş ekimi, genetik faktörler, aşırı epilasyon veya yaralanmalar sonucu kaş bölgesinde seyrekleşme ve şekil bozuklukları yaşayan kişiler için uygulanan bir işlemdir. Saç ekimine benzer bir teknikle, kişinin kendi saç köklerinin kaş bölgesine nakledilmesiyle gerçekleştirilir. Bu işlem sayesinde doğal görünümlü, kalıcı ve dolgun kaşlar elde edilir.', 
  ...
  '1. Konsültasyon: Kaş yapınız ve beklentileriniz değerlendirilir.
2. Planlama: İdeal kaş şekli çizilir ve donör bölge belirlenir.
3. Anestezi: Lokal anestezi uygulanır.
4. Greft Toplama: Başın arka kısmından ince saç kökleri alınır.
5. Kanal Açma: Kaş bölgesinde mikro kanallar açılır.
6. Yerleştirme: Greftler bu kanallara yerleştirilir.
7. Tamamlama: İşlem sonrası bakım talimatları verilir.',
...
7. დასრულება: წარმოდგენილია პროცედურის შემდგომი მოვლის ინსტრუქციები.',
  ...
  'Kaş ekimi için ideal adaylar:
- Seyrek veya şekilsiz kaşları olanlar
- Kaş alopesisi olanlar
- Yaralanma veya yanık sonucu kaş kaybı yaşayanlar
- Genel sağlık durumu iyi olanlar
- Gerçekçi beklentileri olanlar',
...
- İlk 3 gün boyunca nakil bölgesine dokunmayın
- 2 hafta boyunca kaşlarınızı yıkamayın
- Doktorunuzun önerdiği ürünleri kullanın
- Direkt güneş ışığına maruz kalmaktan kaçının
- Düzenli kontrollere gelin',
