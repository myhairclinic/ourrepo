    ...
    const packages = [
      {
        ...
        features: ["VIP Transfer", "5* Otel", "Şehir Turu", "Türkçe Rehber"],
        durationDays: 5,
        isAllInclusive: true,
        isActive: true,
        isFeatured: true,
      ...
      },
      {
        ...
        features: ["VIP Transfer", "4* Otel", "Kültürel Turlar", "Rusça Rehber"],
        durationDays: 7,
        isAllInclusive: true,
        isActive: true,
        isFeatured: true,
      ...
      },
      {
        ...
        features: ["Lüks Transfer", "5* Otel", "Şehir Turları", "Azeri Rehber"],
        durationDays: 6,
        isAllInclusive: true,
        isActive: true,
        isFeatured: true,
      ...
      },
      {
        ...
        features: ["Özel Transfer", "Deluxe Otel", "Kültürel Etkinlikler", "Kazak Rehber"],
        durationDays: 8,
        isAllInclusive: true,
        isActive: true,
        isFeatured: true,
      ...
      },
      {
        ...
        features: ["Havaalanı Transferi", "Butik Otel", "Doğa Turları", "Ukraynalı Rehber"],
        durationDays: 7,
        isAllInclusive: true,
        isActive: true,
        isFeatured: true,
